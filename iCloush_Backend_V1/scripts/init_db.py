...
async def init():
    ...
    async with AsyncSessionLocal() as session:
        ...
        print("📍 注入工区数据...")
        zones = [
            Zone(id=1, name="洗涤龙", code="zone_a", floor=1, color="#3B82F6",
            ...
            Zone(id=2, name="F1单机洗烘", code="zone_b", floor=1, color="#F59E0B",
            ...
            Zone(id=11, name="F2单机洗烘", code="zone_k", floor=2, color="#F59E0B",
